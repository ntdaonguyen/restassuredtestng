...
import static com.nguyenntd.helpers.JsonHelper.updateValueJsonFile;

public class DemoEditJsonFile {
    @Test
    public void testUpdateValueInJson01() {
    ...
    public void testUpdateDataJson() {
        JsonHelper.updateValueJsonFile("src/test/resources/testdata/TestJsonFile01.json", "totalprice", 222);
        JsonHelper.updateValueJsonFile("src/test/resources/testdata/TestJsonFile01.json", "lastname", "NguyenNTD");
    }
    ...
    public void testUpdateValueInJson02() {
        ...
        try {
            ...
            jsonObject.getAsJsonObject("bookingdates").addProperty("checkout", "2025-04-10");
