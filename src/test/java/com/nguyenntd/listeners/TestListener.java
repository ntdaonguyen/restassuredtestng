package com.nguyenntd.listeners;
...
public class TestListener implements ITestListener {
    ...
    public void onFinish(ITestContext result) {
        ...
        //In ra logs cho biết là đã kết thúc và chạy được bao nhiêu cái pass/fail
        //Gửi mail đến mail chung để nắm bắt tình hình - Lấy ra các biến toàn cục hoặc file logs, report
        LogUtils.info("Đã gửi mail đến nguyenntd@email.com");
